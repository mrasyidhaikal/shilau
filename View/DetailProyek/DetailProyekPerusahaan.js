...
function DetailProyekPerusahaan({ route }) {
  ...
  const handlePickDocument = async () => {
    ...
    const documentName = `${userState.uid}_${Date.now()}.${
      findExt[findExt.length - 1]
    }`
      ...
      <ScrollView>
        ...
        <View style={Style.wrapper}>
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              setDataUsulan({ ...dataUsulan, Nama_Pengusul: text })
            }
          />
          <TextInput
            ...
            onChangeText={(text) =>
              setDataUsulan({ ...dataUsulan, No_Handphone: text })
            }
          />
          <TextInput
            placeholder="E-mail"
            ...
            onChangeText={(text) =>
              setDataUsulan({ ...dataUsulan, Email: text })
            }
          />
          <TextInput
            placeholder="Alamat"
            ...
            onChangeText={(text) =>
              setDataUsulan({ ...dataUsulan, Alamat: text })
            }
          />
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              setDataUsulan({ ...dataUsulan, Judul_Proyek: text })
            }
          />
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              setDataUsulan({ ...dataUsulan, Deskripsi: text })
            }
          />
          <TextInput
            editable={!enabled}
            ...
            onChangeText={(text) =>
              setDataUsulan({ ...dataUsulan, Luaran: text })
            }
          />
          ...
          >
            <Text style={{ paddingTop: 11, color: 'white' }}>
              {dataUsulan.NameFile.substr(0, 30)}...
            </Text>
          </TouchableOpacity>
          <Text style={[Style.textNormalWhite, { marginBottom: 20 }]}>
